        ...
        <div
            ...
            <template v-if="popUpType === 'confirm'">
                ...
                <div class="pop-up__buttons">
                    <button
                        class="btn btn-danger pop-up__button pop-up__button_no"
                        type=button
                        @click="changePopUpType(null)">
                        No
                    </button>
                    <button
                        class="btn btn-success pop-up__button pop-up__button_yes"
                        type=button
                        @click="confirmYes">
                        Yes
                    </button>
            ...
            <template v-else-if="popUpType === 'reg'">
                <div
                    class="reg-block pop-up__reg-block"
                    key="reg-block">
                    <h2 class="reg-block__title pop-up__title">
                        <span class="fa fa-user-plus reg-block__title-icon" />
                        Registration
                    </h2>
                    <form
                        class="form needs-validation reg-block__form"
                    ...
                    <a
                        ...
                        <span class="fa fa-sign-in form__cross-link_sign-in-icon" />
                        Sign in
                    </a>
                </div>
            </template>
            <template v-else-if="popUpType === 'auth'">
                <div
                    class="auth-block pop-up__auth-block"
                    key="auth-block">
                    <h2 class="auth-block__title pop-up__title">
                        <span class="fa fa-sign-in auth-block__title-icon" />
                        Authorization
                    </h2>
                    <form
                        class="form needs-validation auth-block_form"
                        ref="auth-form"
                    ...
                    <a
                        ...
                        <span class="fa fa-user-plus form__cross-link_sign-up-icon" />
                        Sign up
                    </a>
                </div>
            </template>
