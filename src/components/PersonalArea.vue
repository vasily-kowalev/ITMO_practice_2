<template>
    <main class="main column" :class="'main_' + state">
        <section class="options main__options">
            <div class="row select-service options__select-service">
                <select class="col-5 custom-select select-service__select" v-model="selectedOption">
                ...
                <button class="btn btn-success col-auto select-service__submit" 
                        type="submit" 
            ...
            <div class="row custom-control custom-checkbox 
                ...
                <label for="show-active-orders-only" 
...
<script>
    ...
    export default {
        props: ['state', 'orderedServices', 'services', 'preferServiceId'],
        data() {
